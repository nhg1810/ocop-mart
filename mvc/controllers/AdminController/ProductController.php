...
class product extends Controller
{
   ...
   {
      if (
         $this->ProductModel->GetAllTheFaceProduct() == false ||
   ...
   function UpdateProductById()
   {
      if (isset($_POST['dtn_id_product'])) {
         ...
         $rs_update_product = $this->ProductModel->UpdateProductById(
            $idProduct,
            $nameProduct,
            $idCateProduct,
            $descriptProduct,
   ...
   function AddProduct()
   {
      if (isset($_POST['dtna_idCategoryCurrent'])) {
         ...
         $rs_insert_product_admin = $this->ProductModel->InsertProduct(
            $idCateProduct,
            $nameProduct,
            $descriptProduct,
            $brand,
         ...
         if ($rs_product_by_idcategory != false) {
            ...
            foreach ($set_product_by_cate_admin as $key => $value) {
               ...
               <img src="./mvc/public/ImgProduct/' . $set_product_by_cate_admin[$key]['imgProd4'] . '" alt="image" />
                   ...
                   ';
                  if ($set_product_by_cate_admin[$key]['status'] == 0) {
